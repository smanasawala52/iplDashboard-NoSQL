...
import com.example.ipldashboardnosql.repository.VenueRepository;
...
public class VenueService {
	...
	public Venue getVenueByName(String venueName, int cp) {
		...
		if (venue != null) {
			venue.setMatches(matchRepository.getByVenueOrderByDateDesc(venueName, cp, PAGE_SIZE).getContent());
			List<ICity> temp = matchRepository.getTeam1ByVenueOrderByTeam1(venueName);
