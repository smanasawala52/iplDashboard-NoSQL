...
public class TeamController {
	...
	public ModelAndView getTeamByName1AndName2(@PathVariable("teamName1") String teamName1,
		...
		modelAndView.addObject("teams", teamService.getTeamByName1AndName2(teamName1, teamName2, cp, venue, 10));
		if (!venue.isEmpty()) {
		...
		modelAndView.addObject("pageBaseUrl", "/teams/" + teamName1 + "/" + teamName2 + "?venue=" + venue);
	...
	public ModelAndView getTeamByName1(@PathVariable("teamName1") String teamName1,
		...
		modelAndView.addObject("pageBaseUrl", "/teams/" + teamName1 + "?venue=" + venue);
